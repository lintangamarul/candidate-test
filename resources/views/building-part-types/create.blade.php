...
@section('title', 'Create Building Part Type - CLT Toolbox')
@section('page-title', 'Create New Building Part Type')
...
<div class="bg-white rounded-lg shadow">
    <div class="p-6">
        <form action="{{ route('building-part-types.store') }}" method="POST">
            @csrf
